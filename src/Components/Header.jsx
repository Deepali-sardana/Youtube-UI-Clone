    ...
    <>
      <div className='sticky top-0 z-10 flex flex-row items-center justify-between h-14 px-4 md:px-5 bg-black dark:bg-white'>
        ...
        <div className='flex h-5 items-center'>
            ...
            <img className='h-full  dark:md:block' src='youtube.png' alt='youtube'/>
            </Link>
        ...
        <div className='flex items-center'>
            <div className='hidden md:flex'>
                ...
                <div className='flex items-center justify-center h-10 w-10 rounded-full hover:bg-[#303030]/[0.6] md:ml-4'>
                    <FiBell className='text-white text-xl cursor-pointer'/>
                </div>
                <div className='flex items-center justify-center h-10 w-10 overflow:hidden rounded-full bg-[#ab2a54] md:ml-4'>
                    <h1 className='text-white text-xl cursor-pointer '>D</h1>
                </div>
            </div>
