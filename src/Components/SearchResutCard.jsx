...
export default function SearchResutCard(video) {
  return (
    <>
    <Link to={`/video/${video?.videoId}`}>
        <div className='flex flex-col md:flex-row mb-8 md:mb-3 lg:hover:bg-white/[0.1] rounded-xl md:p-4'>
            <div className='relative flex shrink-0 h-48 md:h-28 lg:h-40 xl:h-48 w-full md:w-48 ld-w-64 xl:w-80 rounded-xl
            ...
            <div className='flex flex-col ml-4 md:ml-6 mt-4 md:mt-0 overflow-hidden'>
                ...
                <span className='empty:hidden text-sm line-clamp-1 text-white/[0.7] md:pr-24 md:py-4'>
